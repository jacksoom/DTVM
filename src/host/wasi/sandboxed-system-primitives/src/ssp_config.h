...
#ifdef __APPLE__
#define stat_st_atim st_atimespec
#define stat_st_ctim st_ctimespec
#define stat_st_mtim st_mtimespec
#else
#define stat_st_atim st_atim
#define stat_st_ctim st_ctim
#define stat_st_mtim st_mtim
#endif
